...
log = logging.getLogger("core.rpc")
...
class PsyRpc(JsonRpc):
    ...
    def remove_method(self, method):
        ...
        new_methods = {name: meth for name, meth in self.methods.items() if name != meth_name}
...
class RPC:
    ...
    async def initialize(self, port: int = 7821):
        """
